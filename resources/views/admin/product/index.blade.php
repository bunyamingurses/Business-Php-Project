            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="carouselTable" width="100%" cellspacing="0">
                    ...
                    @foreach($product as $productWrite)
                        <tr>
                            <td><img src="{{ asset("imageAvif/product/")."/".$productWrite->imagesAvif }}" width="200px" alt=""></td>
                            <td>{{ $productWrite->title }}</td>
                            <td>{{ $productWrite->titleEnglish }}</td>
                            <td>{{ \App\Models\category::getName($productWrite->categoryId) }}</td>
                            <td>
                                <a href="{{ route("admin.product.gallery.index",["id"=>$productWrite->id]) }}" class="btn btn-primary"><span class="fa fa-images"></span></a>
                            </td>
