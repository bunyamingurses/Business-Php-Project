        ...
        <div class="container">
            <div class="topbar-five__inner">
                <div class="topbar-five__info">
                    <div class="topbar-five__info__icon"><i class="tolak-icons-two-global-solution"></i></div> Address: {{ \App\Models\setting::getSetting("address") }}
                </div><!-- /.topbar-five__info -->
                <div class="topbar-five__right">
                    <div class="topbar-five__language">
                        <a href="#"><img src="{{ asset("asset/front/images/shapes/flag.png") }}"
                                         alt="tolak"/>English</a>
            ...
            <div class="main-header-five__inner">
                ...
                <nav class="main-header-five__nav main-menu">
                    <ul class="main-menu__list">
                        <li>
                            <a href="{{ route("indexHtmlEN") }}">Homepage</a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route("productHtmlEN") }}">Products</a>
                        </li>
                        <li>
                            <a href="{{ route("qualityPolicyHtmlEN") }}">Quality Policy</a>
                        </li>
                        <li>
                            <a href="{{ route("kvkkHtmlEN") }}">KVKK</a>
                        </li>
                        <li>
                            <a href="{{ route("contactHtmlEN") }}">Contact</a>
                        </li>
                    </ul>
                ...
                <div class="main-header-five__right">
                    ...
                    <a href="{{ route("contactHtmlEN") }}" class="tolak-btn-two main-header-five__btn">
