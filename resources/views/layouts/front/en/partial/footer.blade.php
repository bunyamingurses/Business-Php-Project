            ...
            <div class="col-md-6 col-lg-3">
                <div class="footer-widget footer-widget--links">
                    ...
                    <ul class="list-unstyled footer-widget__links">
                        <li><a href="{{ route("aboutHtmlEN") }}">About Us</a></li>
                        ...
                        @foreach($productFooter as $productWrite)
                            <li class="footer-widget__posts__item">
                                <div class="footer-widget__posts__image">
                                    <a href="{{ route("productDetailHtmlEN",["id"=>$productWrite->id,"name"=>\App\Http\Controllers\support\functionController::seo($productWrite->titleEnglish)]) }}"><img src="{{ asset("imageAvif/product/")."/".$productWrite->imagesAvif }}" alt="{{ $productWrite->titleEnglish }}"></a>
                                ...
                                <div class="footer-widget__posts__content">
                                    ...
                                    <h4 class="footer-widget__posts__title"><a href="{{ route("productDetailHtmlEN",["id"=>$productWrite->id,"name"=>\App\Http\Controllers\support\functionController::seo($productWrite->titleEnglish)]) }}">{{ $productWrite->titleEnglish }}</a></h4><!-- /.sidebar__posts__title -->
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p class="main-footer-four__copyright">
                            &copy; Copyright <span class="dynamic-year"></span> COLIZO All Rights Reserved.
                        </p>
                    </div>
                    <div class="col-md-6">
...
<div class="mobile-nav__wrapper">
    ...
    <div class="mobile-nav__content">
        ...
        <div class="logo-box">
            <a href="{{ route("indexHtmlEN") }}" aria-label="logo image"><img
