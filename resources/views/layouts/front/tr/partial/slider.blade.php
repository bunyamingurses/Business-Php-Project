                    ...
                    <div class="container">
                        <div class="main-slider-five__content">
                            <h5 class="main-slider-five__sub-title"><span
                                    class="main-slider-five__sub-title__border"></span>{{ \App\Models\category::getName($productWrite->categoryId) }}</h5>
                            <!-- slider-sub-title -->
                            <h2 class="main-slider-five__title">{{ $productWrite->title }}</h2>
                            <!-- slider-title -->

                            <ul class="main-slider-five__list">
                                <li><i class="tolak-icons-two-badge-check"></i>Kalite</li>
                                <li><i class="tolak-icons-two-global-solution"></i>Lider Çalışma</li>
                            </ul>
                            <div class="main-slider-five__btn">
                                <a href="{{ route("productDetailHtmlTR",["id"=>$productWrite->id,"name"=>\App\Http\Controllers\support\functionController::seo($productWrite->title)]) }}" class="tolak-btn-two">
                                    <span class="tolak-btn-two__left-star"></span>
                                    <span>ÜRÜN'Ü GÖR<i class="tolak-icons-two-arrow-right-short"></i></span>
