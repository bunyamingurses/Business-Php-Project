...
@section("content")
    ...
    <section class="about-three">
        <h2 class="sec-title-two__tagline text-center"><span
            ...
            KALİTE POLİTİKASI<span class="sec-title-two__tagline__right icofont-rounded-double-right"></span>
        </h2>
        <!-- /.sec-title-two__tagline -->
        <h1 class="text-center">COLİZO KALİTE POLİTİKASI</h1>
                ...
                <div class="col-lg-12 wow fadeInRight animated mt-4" data-wow-delay="200ms"
                    ...
                    <div class="about-three__content">
                        ...
                        <p class="font-weight-normal">
                            {!! html_entity_decode(\App\Models\about::getAbout("qualityPolicy")) !!}
                        </p>
