                        ...
                        <div class="contact-two__info">
                            ...
                            <ul class="contact-two__info__box-wrapper">
                                <li class="contact-two__info__box">
                                    ...
                                    <h4 class="contact-two__info__box__title">Call Us</h4>
                                ...
                                <li class="contact-two__info__box">
                                    ...
                                    <h4 class="contact-two__info__box__title">E-Mail</h4>
                                    <p class="contact-two__info__box__text"><a
                        ...
                        <div class="contact-two__content">
                            <div class="sec-title-two text-left">
                                <h6 class="sec-title-two__tagline"><span
                                        class="sec-title-two__tagline__left icofont-rounded-double-left"></span>Write Us<span
                                        class="sec-title-two__tagline__right icofont-rounded-double-right"></span></h6>
                                <!-- /.sec-title-two__tagline -->
                                <h3 class="sec-title-two__title">Send your messages and questions..</h3>
                            ...
                            @endif
                            <form class="contact-two__form form-one" action="{{ route("contactPostEN") }}" method="post">
                                <div class="form-one__group">
                                    @csrf
                                        ...
                                        <textarea id="message" name="message" required
                                                  placeholder="Specify Your Message!" ></textarea>

                                        </div><!-- /.form-one__control -->

                                    <div class="form-one__control form-one__control--full">
                                        <button type="submit" class="tolak-btn"><b>Send Message</b> <i class="fa fa-arrow-alt-circle-right"></i> <span></span>
                                        </button>
                                    </div><!-- /.form-one__control -->
                                </div><!-- /.form-one__group -->
                            </form>
